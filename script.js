        ...
        if (result.success && result.data.length > 0) {
            ...
            result.data.slice(0, 6).forEach(story => {
                ...
                testimonialCard.innerHTML = `
                    ...
                    ${story.image ? `<div class="testimonial-image" style="margin: 15px 0;"><img src="${story.image}" alt="${escapeHtml(story.name)}" style="width: 100%; max-height: 300px; object-fit: cover; border-radius: 10px; border: 2px solid rgba(102, 126, 234, 0.3);"></div>` : ''}
